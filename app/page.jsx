      ...
      <main className={styles.main}>
        ...
        <div className={styles.content_container}>
          ...
          <div className={styles.txt}>
            <ContentSection src={"carta1.png"} alt={"exemplo de cartas"} title="Explicação do TCG" text="Um sistema de cartas com dois tipos principais sendo as cartas de personagem. No começo de cada jogo é sorteado 5 cartas de personagens, o objetivo é conseguir derrotar os 5 personagens do adversário para ganhar a partida." />
